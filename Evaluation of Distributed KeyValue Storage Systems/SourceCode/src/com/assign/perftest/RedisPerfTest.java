...
public class RedisPerfTest {
	...
	public RedisPerfTest() throws SecurityException, IOException{
		prop = new Properties();
		logger = Logger.getLogger("PerfTestRedis");
		fileHandler = new FileHandler("perfLogRedis.log");
		...
		redisClient = new RedisClient(serverIPs, numOfServers);
	}
	...
	public static void main(String[] args) throws SecurityException, IOException {
		...
		RedisPerfTest test = new RedisPerfTest();
	...
	private void testPut(ArrayList<String> keys, ArrayList<String> values) {
		...
		for (int i=0; i< numOfReqs; i++){
			redisClient.put(keys.get(i), values.get(i));
		}
